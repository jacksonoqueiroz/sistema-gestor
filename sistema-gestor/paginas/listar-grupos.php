...
<div class="container py-4">
	<header class="pb-3 mb-4">		
		...
		<div class="row">
			...
			<div class="col-md-3 list-icon">
				<a href="<?php echo URL ?>cadastrar-grupos"><i class="fa fa-clipboard"></i></a>
			</div>
    ...
    $query_op = "SELECT id, nome, descricao FROM grupos LIMIT $inicio, $limite_resultado";
              ...
              <tr>                
                ...
                <td class="row">
                	<div class="col-2 action-icon">
                		<a href="<?php echo URL . 'peca-grupo?id_grupo=' . $id . 'nome=' . $nome ?>" data-placement="bottom" title="Consultar Peça"><i class="fa fa-cog"></i></a>
                		</div>
                	<div class="col-2 action-icon">
                		<a href="<?php echo URL . 'editar-grupo?id_grupo=' . $id ?>"><i class="fa fa-pen"></i></a>
                		</div>
                	<!-- <div class="col-2 action-icon">
                			<a href="<?php echo URL . 'excluir-grupo?id_grupo=' . $id . ', nome=' . $nome ?>"><i class="fa fa-trash" onclick=""></i></a>
                		</div> -->
                		<div class="col-2 action-icon">
                			<a onclick="apagarRegistro(<?php echo $id ?>)" href="<?php echo URL . 'excluir-grupo?id_op=' . $id . ', nome=' . $nome ?>"><i class="fa fa-trash"></i></a>
                		</div>
                </td>
                </tr>
  ...
  <ul class="pagination">
    <li class="page-item">
      ...
      <?php echo "<a class='page-link' href='listar-grupos?page=1'>Primeira</a> "; ?>
    </li>
    ...
    <li class="page-item">
    	...
    	<?php
				if ($pagina_anterior >= 1) {
					echo "<a class='page-link' href='listar-grupo?page=$pagina_anterior'>$pagina_anterior</a> ";
				}
    ...
    <?php 
		...
		<li class="page-item">
    		<?php
							if($proxima_pagina <= $qnt_pagina){
								echo "<a class='page-link' href='listar-grupos?page=$proxima_pagina'> $proxima_pagina </a> ";
							}
    ...
    <li class="page-item">
      <?php echo "<a class='page-link' href='listar-grupos?page=$qnt_pagina'>Última</a> "; ?>
    </li>
  </ul>
</nav>
