...
<div class="container py-4">
	<header class="pb-3 mb-4">		
		...
		<div class="row">
			...
			<div class="col-md-3 list-icon">
				<a href="<?php echo URL ?>cadastrar-itens"><i class="fa fa-clipboard"></i></a>
			</div>
    ...
    $query_reg = "SELECT item.id AS id_item,
                          ...
                          peca.nome AS peca 
                  FROM itens AS item
                  INNER JOIN peca AS peca ON peca.id=item.id_peca ORDER BY id_peca ASC LIMIT $inicio, $limite_resultado";
              ...
              <tr>
                ...
                <td class="row">
                	<div class="col-2 action-icon">
                		<a href="<?php echo URL . 'detalhes-item?id_item=' . $id_item ?>"><i class="fa fa-eye"></i></a>
                		</div>
                	<div class="col-2 action-icon">
                		<a href="<?php echo URL . 'editar-item?id_item=' . $id_item ?>"><i class="fa fa-pen"></i></a>
                		</div>
                	<!-- <div class="col-2 action-icon">
                			<a href="<?php echo URL . 'excluir-item?id_item=' . $id . ', nome=' . $nome ?>"><i class="fa fa-trash" onclick=""></i></a>
                		</div> -->
                		<div class="col-2 action-icon">
                			<a onclick="apagarRegistro(<?php echo $id ?>)" href="<?php echo URL . 'excluir-item?id_item=' . $id_item ?>"><i class="fa fa-trash"></i></a>
                		</div>
                </td>
                </tr>
	...
	?>
		...
		//Contar a quantidade de registros no Banco de Dados
			$query_qnt_resgistros = "SELECT count(id) AS num_result FROM itens";
  ...
  <ul class="pagination">
    <li class="page-item">
      ...
      <?php echo "<a class='page-link' href='listar-itens?page=1'>Primeira</a> "; ?>
    </li>
    ...
    <li class="page-item">
    	...
    	<?php
				if ($pagina_anterior >= 1) {
					echo "<a class='page-link' href='listar-itens?page=$pagina_anterior'>$pagina_anterior</a> ";
				}
    ...
    <?php 
		...
		<li class="page-item">
    		<?php
							if($proxima_pagina <= $qnt_pagina){
								echo "<a class='page-link' href='listar-itens?page=$proxima_pagina'> $proxima_pagina </a> ";
							}
    ...
    <li class="page-item">
      <?php echo "<a class='page-link' href='listar-itens?page=$qnt_pagina'>Última</a> "; ?>
    </li>
  </ul>
</nav>
