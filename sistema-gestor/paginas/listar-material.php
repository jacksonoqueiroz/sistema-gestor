...
<div class="container py-4">
    ...
    $inicio = ($limite_resultado * $pagina) - $limite_resultado;
		...
		// Recuperar os GRUPOS
    $query_reg = "SELECT id, nome, descricao FROM material LIMIT $inicio, $limite_resultado";
              ...
              <tr>
                ...
                <td class="row">
                	<div class="col-2 action-icon">
                		<a href="<?php echo URL . 'detalhes-item?id_material=' . $id_item ?>"><i class="fa fa-eye"></i></a>
                		</div>
                	<div class="col-2 action-icon">
                		<a href="<?php echo URL . 'editar-item?id_material=' . $id_item ?>"><i class="fa fa-pen"></i></a>
                		</div>
                	<!-- <div class="col-2 action-icon">
	...
	?>
		...
		//Contar a quantidade de registros no Banco de Dados
			$query_qnt_resgistros = "SELECT count(id) AS num_result FROM material";
