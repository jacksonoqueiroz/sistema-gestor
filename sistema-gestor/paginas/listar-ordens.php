...
<div class="container py-4">
    ...
    $inicio = ($limite_resultado * $pagina) - $limite_resultado;
		...
		// Recuperar os GRUPOS
    $query_reg = "SELECT ordem.id AS id_ordem,
                          modelo.nome, 
                          ordem.motivo,
                          ordem.qtd_itens,
                          ordem.codigo,                          
                  ...
                  INNER JOIN produtos AS modelo ON modelo.id=ordem.id_modelo LIMIT $inicio, $limite_resultado";
              ...
              <tr>
                ...
                <td class="row">
                	<div class="col-2 action-icon">
                		<a href="<?php echo URL . 'peca-ordem?id_ordem=' . $id_ordem ?>"><i class="fa fa-eye"></i></a>
                		</div>
                	<div class="col-2 action-icon">
	...
	?>
		...
		//Contar a quantidade de registros no Banco de Dados
			$query_qnt_resgistros = "SELECT count(id) AS num_result FROM ordem_producao";
  ...
  <ul class="pagination">
    <li class="page-item">
      ...
      <?php echo "<a class='page-link' href='listar-material?page=1'>Primeira</a> "; ?>
    </li>
    ...
    <li class="page-item">
    	...
    	<?php
				if ($pagina_anterior >= 1) {
					echo "<a class='page-link' href='listar-material?page=$pagina_anterior'>$pagina_anterior</a> ";
				}
    ...
    <?php 
		...
		<li class="page-item">
    		<?php
							if($proxima_pagina <= $qnt_pagina){
								echo "<a class='page-link' href='listar-material?page=$proxima_pagina'> $proxima_pagina </a> ";
							}
    ...
    <li class="page-item">
      <?php echo "<a class='page-link' href='listar-material?page=$qnt_pagina'>Última</a> "; ?>
    </li>
  </ul>
</nav>
